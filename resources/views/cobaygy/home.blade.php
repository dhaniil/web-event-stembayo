  ...
  <div class="carousel-inner">
                    ...
                    <div class="carousel-inner">
                            ...
                            <div class="row">
                                <div class="col-lg-3 col-md-4 col-sm-6 col-12" v-for="(card, index) in cards" :key="index">
                                    <div class="card">
                                        ...
                                        <div class="deskripsi d-flex flex-column justify-content-end">
                        ...
                        <div class="row">
                            ...
                            <!-- <div class="col-lg-3 col-md-4 col-sm-6 col-12">
                                    <div class="card">
                                        <img src="https://studio.mrngroup.co/storage/app/media/Prambors/Events/Skulprize%202023-20230515185504.webp" class="card-img-top" alt="Card Image 1">
                                        <div class="card-body">
    ...
    var app = new Vue({
        ...
        data: {
            ...
            cards: [
                {
                    image: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTZ3q3cLt4K3KSPZTNA-8UeyEr_t4EAtaorGw&s',
